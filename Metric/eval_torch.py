...
if __name__ == '__main__':
    if __name__ == '__main__':
        with_mean = True
        config = {
            'dataroot': r'../dataset/',  # Change to your local infrared and visible images path
            'results_root': r'../fusion_result/',  # Change to your local fusion images path  -fusion_result
            'dataset': r'MSRS',  # Specify the dataset name
            'save_dir': r'../msrs'  # Directory for saving metrics
        }
